...
public class FreshPointSecondaryAccountTaxApprovalTest extends TestBase {
    ...
    public void testVerifyFreshPointSecondaryAccountTaxApprovalFlow(ITestContext context) {

        //Get Account name from context
        String accountName = (String) context.getAttribute("FPSecondaryAccountName");
