...
public class ReactivationApprovalTest extends TestBase {
    ...
    public static void initiate(ITestContext iTestContext) {
        iTestContext.setAttribute(FEATURE_QCENTER, MODULE_UI_MDMC_CC_CFEA + " - " + FEATURE_UI_CFEA_FP_ACC_MAINTENANCE);
    }
