...
public class AsianFoodsSecondaryAccountTaxApprovalTest extends TestBase {
    ...
    public void testVerifyAsianFoodsSecondaryAccountTaxApprovalFlow(ITestContext context) {

        //Get Account name from context
        String accountName = (String) context.getAttribute("AFSecondaryAccountName");
