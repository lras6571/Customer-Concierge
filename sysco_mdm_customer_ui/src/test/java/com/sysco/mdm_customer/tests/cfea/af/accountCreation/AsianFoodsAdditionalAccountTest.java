...
public class AsianFoodsAdditionalAccountTest extends TestBase {
    ...
    @Test(description = "MDMC-TC-5228", priority = 1)
    public void testVerifyCFEAAsianFoodsAdditionalAccountLeadSearch(ITestContext context) {
        ...
        String leadNameForNLA = CFEALeadCreation.retrieveLeadName(expectAFLeadRequest.getCompanyName());

        //Navigate to the Customer Concierge Lobby
        NavigateToCustomerConcierge.selectCustomerConcierge();

        //Click Additional Account flow for Create CFEA Accounts
    ...
    @Test(description = "MDMC-TC-5230", priority = 2)
    public void testVerifyCFEAAsianFoodsAdditionalAccountAccountInfo() {
    ...
    @Test(description = "MDMC-TC-5232", priority = 3)
    public void testVerifyCFEAAsianFoodsAdditionalAccountContactInfo() {
    ...
    @Test(description = "MDMC-TC-5234", priority = 4)
    public void testVerifyCFEAAsianFoodsAdditionalAccountShipToConfirmation() {

        CFEAShipToConfirmationScreen.clickNextShipToConfirmation(NLA);

    }

    @Test(description = "MDMC-TC-5239", priority = 5)
    public void testVerifyCFEAAsianFoodsAdditionalAccountCreditApproval(ITestContext context) throws InterruptedException {
        ...
        context.setAttribute("AFAdditionalAccountName", CFEAContactInfoScreen.retrieveNameInfo(expectAFLeadRequest.getFirstName(), expectAFLeadRequest.getLastName()));
