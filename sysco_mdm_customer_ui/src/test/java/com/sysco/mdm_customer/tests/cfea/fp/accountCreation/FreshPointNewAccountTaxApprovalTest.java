...
public class FreshPointNewAccountTaxApprovalTest extends TestBase {
    ...
    public void testVerifyFreshPointNewAccountTaxApprovalFlow(ITestContext context) {

        //Get Account Owner name from context
        String accountName = (String) context.getAttribute("FPAccountOwnerName");
