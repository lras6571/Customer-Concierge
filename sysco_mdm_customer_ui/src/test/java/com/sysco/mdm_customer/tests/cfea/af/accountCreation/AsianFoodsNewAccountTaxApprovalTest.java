...
public class AsianFoodsNewAccountTaxApprovalTest extends TestBase {
    ...
    public void testVerifyAsianFoodsNewAccountTaxApprovalFlow(ITestContext context) {

        //Get Account Owner name from context
        String accountName = (String) context.getAttribute("AFAccountOwnerName");
        ...
        TaxApprovalScreen.clickNextBillingAddressVerification();
