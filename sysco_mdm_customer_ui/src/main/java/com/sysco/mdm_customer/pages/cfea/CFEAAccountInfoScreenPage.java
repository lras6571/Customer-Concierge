...
public class CFEAAccountInfoScreenPage {
    ...
    protected By drpDownValueUS = By.xpath("(//span[contains(text(),'United State')])[1]");
    ...
    protected By lblContactInfo = By.xpath("//div[contains(text(),'Contact Information')]");
    ...
    public void enterAccountName(String accountName) {
        ...
        syscoLabUI.sendKeys(txtAccountName,  generatedAccountName + " " + accountName);
        LoggerUtil.logINFO("Enter the Account Name as : " + generatedAccountName + " " + accountName);
    }

    //Retrieve Account Name
    public String retrieveAccountName(String accountName) {
        return generatedAccountName + " " + accountName;
    }
...
//        LoggerUtil.logINFO("Click State in the Fields");
    ...
    public void enterCountry(String country) {
        syscoLabUI.clickWithJavascript(drpDwnCountry);
        syscoLabUI.waitTillElementLoaded(drpDownValueUS,5);
        syscoLabUI.clickWithJavascript(drpDownValueUS);
//        syscoLabUI.sendKeys(drpDwnCountry, country);
    ...
    public void clickNextAddressConfirm() {
        try {
            syscoLabUI.waitTillElementLoaded(lblConfirmAddress, 10);
            syscoLabUI.clickWithJavascript(btnNextAccountInfo);
